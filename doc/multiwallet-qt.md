...
In order to support loading of multiple wallets in vulcano-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vulcano.cpp.
...
Changes to vulcano.cpp
----------------------
vulcano.cpp is the entry point into vulcano-qt, and as such, will require some minor modifications to provide hooks for

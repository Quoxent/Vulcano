Contributing to Vulcano Core
============================

The Vulcano Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vulcano Core project, and is not to be
confused with overall Vulcano Network Protocol consensus changes.

Whether a pull request is merged into Vulcano Core rests with the project merge
...
Patches that change Vulcano consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vulcano consensus, it must have been
...
The project leader is the release manager for each Vulcano Core release.

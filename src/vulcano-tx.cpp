...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vulcano Core vulcano-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vulcano-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vulcano transaction") + "\n" +
                               "  vulcano-tx [options] -create [commands]   " + _("Create hex-encoded vulcano transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vulcano transaction

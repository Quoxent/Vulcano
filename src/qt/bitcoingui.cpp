                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Vulcano Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    QPixmap overviewIconActive(":icons/overview_m");
    ...
    QPixmap sendIconActive(":icons/send_m");
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vulcano address"));
    ...
    QPixmap receiveIconActive(":icons/receiving_addresses_m");
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vulcano: URIs)"));
    ...
    QPixmap historyIconActive(":icons/history_m");
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        ...
        QPixmap masternodesIconActive(":icons/masternodes_m");
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vulcano Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vulcano Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vulcano"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vulcano addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vulcano addresses"));
    ...
    openAction->setStatusTip(tr("Open a Vulcano: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Vulcano Core help message to get a list with possible Vulcano command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vulcano Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Vulcano Core"); // default title

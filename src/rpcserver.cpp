...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"vulcano", "masternode", &masternode, true, true, false},
        {"vulcano", "listmasternodes", &listmasternodes, true, true, false},
        {"vulcano", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vulcano", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vulcano", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vulcano", "masternodedebug", &masternodedebug, true, true, false},
        {"vulcano", "startmasternode", &startmasternode, true, true, false},
        {"vulcano", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vulcano", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vulcano", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vulcano", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vulcano", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vulcano", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vulcano", "mnbudget", &mnbudget, true, true, false},
        {"vulcano", "preparebudget", &preparebudget, true, true, false},
        {"vulcano", "submitbudget", &submitbudget, true, true, false},
        {"vulcano", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vulcano", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vulcano", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vulcano", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vulcano", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vulcano", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vulcano", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vulcano", "checkbudgets", &checkbudgets, true, true, false},
        {"vulcano", "mnsync", &mnsync, true, true, false},
        {"vulcano", "spork", &spork, true, true, false},
        {"vulcano", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vulcano", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vulcanod, or the -server option to vulcano-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vulcano-cli " + methodname + " " + args + "\n";
}

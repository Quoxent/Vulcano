...
RESOURCES += src/qt/vulcano.qrc src/qt/vulcano_locale.qrc

TRANSLATIONS += src/qt/locale/vulcano_bg.ts \
                src/qt/locale/vulcano_de.ts \
                src/qt/locale/vulcano_en.ts \
                src/qt/locale/vulcano_es.ts \
                src/qt/locale/vulcano_fi.ts \
                src/qt/locale/vulcano_fr.ts \
                src/qt/locale/vulcano_it.ts \
                src/qt/locale/vulcano_ja.ts \
                src/qt/locale/vulcano_pl.ts \
                src/qt/locale/vulcano_pt.ts \
                src/qt/locale/vulcano_ru.ts \
                src/qt/locale/vulcano_sk.ts \
                src/qt/locale/vulcano_sv.ts \
                src/qt/locale/vulcano_vi.ts \
                src/qt/locale/vulcano_zh_CN.ts \
                src/qt/locale/vulcano_zh_TW.ts
